...
$pdf->Cell(140, 7, "  " . $_GET['fecha'], 1, 0, 'C');
$pdf->Ln();
...
$pdf->Cell(140, 7, $_GET['cedula'], 1, 0, 'C');
$pdf->Ln();
$pdf->SetTextColor('0', '0', '0');
$pdf->Cell(50, 7, "Eamil ", 1, 0, 'C');
$pdf->SetTextColor('124', '126', '128');
$pdf->Cell(140, 7, utf8_decode($_GET['email']), 1, 0, 'C');
$pdf->Ln();
$pdf->SetTextColor('0', '0', '0');
$pdf->Cell(50, 7, "Edad ", 1, 0, 'C');
$pdf->SetTextColor('124', '126', '128');
$pdf->Cell(140, 7, $_GET['edad'], 1, 0, 'C');
//$pdf->Image('../../img/zahialogo.jpg', 147, 10, 50);
$pdf->Ln();
$pdf->SetTextColor('0', '0', '0');
$pdf->Cell(50, 7, "A nombre de ", 1, 0, 'C');
$pdf->SetTextColor('124', '126', '128');
$pdf->Cell(140, 7, utf8_decode($_GET['nombre']), 1, 0, 'C');
$pdf->Ln();
$pdf->Ln();
$pdf->SetTextColor('0', '0', '0');
...
if ($_GET['cintura_alta']!== "" || $_GET['cintura_media']!== "" || $_GET['cintura_baja']!== ""){
    $pdf->Ln();
    $pdf->SetTextColor('0', '0', '0');
...
if($_GET['brazo_izquierdo'] !== "" || $_GET['brazo_derecho'] !== "" ||$_GET['muslo_izquierdo'] !== "" || $_GET['muslo_derecho'] !== "" ){
...
$pdf->Write(7, utf8_decode($_GET['examen_fisico']));
$pdf->Ln();
$pdf->Ln();
$pdf->SetTextColor('0', '0', '0');
$pdf->Write(7, "Factura");
...
$pdf->SetTextColor('124', '126', '128');
$pdf->SetFont('ARIAL', 'B', 12);
$pdf->Write(7, utf8_decode($_GET['factura']));
$pdf->Ln();
$pdf->Ln();
$pdf->SetTextColor('0', '0', '0');
...
$pdf->Output("Facturas/factura".$hoy.".pdf", 'F');
echo "<script language='javascript'>window.open('Facturas/factura".$hoy.".pdf','_self','');</script>"; //para ver el archivo pdf generado
exit;
