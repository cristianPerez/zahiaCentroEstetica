        ...
        <div class="row-fluid">
            ...
            <center>
                <div class="container">
                    ...
                    <form id="formIngresarProducto" action="ajaxuploadAntes.php"  method="POST" enctype="multipart/form-data"> 
                        <center>
                            ...
                            <div id="examen_fisico" class="container-fluid" style="display: none" aria-hidden="true">
                                <div class="container">
                        ...
                        <p><input id="imgono" type="checkbox" name="imgno" value="0" onclick="javascript:cambas2();"> Agregar imagen antes del tratamiento(Opcional)</p>                        
                        <p><input id="imageProduct" value="imageProduct"  name="imageProduct" type="file" class="form-control" disabled="true" required=""/></p>
                        <br/>
                        <textarea style="width:100%; max-width: 100%; min-height: 74px;max-height: 150px" id="desc_antes" name="desc_antes" type="text" class="form-control" placeholder="Descripcion Imagen antes"  required="" disabled="true"></textarea> 
                        <input style="display: none" type="text" id="accionp" name="accionp" value="registrar"/> 
